...
EOF;
               ...
               ?>        
            <?php if($valid){ ?>
            <h1 class="cover-heading">Your reset request is success!</h1>
            <?php } ?>
            <?php if(!$valid){ ?>
            <h1 class="cover-heading">Reset failed! Please try again</h1>
            <?php }?>          
            <div>
               <br>
               <a class="btn btn-primary" href="resetdraw.html" role="button">Back</a>
            </div>
         </main>
