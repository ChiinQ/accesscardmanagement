...
<html lang="en">
   <head>
      ...
      <title>Jabil GBC WINNERS RECORD</title>
      <!-- Bootstrap core CSS -->
   ...
   <body class="text-center">
      <div class="cover-container d-flex w-100 h-100 p-2 mx-auto flex-column">
         ...
         <main role="main" class="inner cover">
            <h1 class="cover-heading">Parking Winners list</h1>
            <br>
...
EOF;
            ...
            <?php if(!$valid){?>
            <h5 class="text-danger">*There are currently no winners in our record!*</h5>
            <?php }?>
         </main>
