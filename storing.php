      ...
      <div class="cover-container d-flex w-100 h-100 p-2 mx-auto flex-column">
         ...
         <main role="main" class="inner cover">
            <?php
               ...
               $data=$name.",".$date.",".$id.",".$department.",".$accesscard;
               ...
               INSERT INTO employeedb (name,starting_date,employee_id,position,accesscardnumber,status) VALUES ('$name', '$date', '$id', '$department', '$accesscard', 'regular' );
...
EOF;
            ...
            <div>
               <br>
               <a class="btn btn-primary" href="newhire.html" role="button">Back</a>
            </div>
         </main>
