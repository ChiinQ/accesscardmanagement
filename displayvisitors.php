...
<html lang="en">
   <head>
      ...
      <title>Jabil GBC SHOW VISITORS</title>
      <!-- Bootstrap core CSS -->
...
EOF;
                     ...
                     while($data = pg_fetch_row($ret)){  //read each line as an array
                      	if (!is_null($data[3])){ 
	                      	...
	                      	echo "<thead >
							    <tr>";
							      echo "<th>Access card</th>";
							      echo "<th>Access card serial</th>";
							      echo "<th>Visitor's name</th>";
							      echo "<th>Visitor's company</th>";
							      echo "<th>Starting date</th>";
							      echo "<th>Ending date</th>";
							      echo "<th>Host's name</th>";
							      echo "<th>Host's contact</th>
							    </tr>
							  </thead>";
                      		}
                      	 $valid = true;
            ...
            <?php if(!$valid){ ?>
            <h5 class="cover-heading text-danger">**There are currently no visitors in record! Please input and try again.**</h5>
            <?php }?>     
         </main>
